...
def get_network(name, batch_size):
    ...
    onnx_model = onnx.load('/home/acer/nfs-share/autoslim_repvgg_a0_ddod_320_320_epoch_160_calibrate_0.5.onnx')
    input_name = "input"
...
def tune_and_evaluate(tuning_opt):
    ...
    with autotvm.apply_history_best(log_file):
        ...
        lib.export_library('/home/acer/play_tvm/deploy_fp16_opt.so')
        # load parameters
